...
export function CanvasDrawing({ imageUrl, onMaskChange, className }: CanvasDrawingProps) {
  ...
  const startDrawing = useCallback((e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    ctx.strokeStyle = tool === 'brush' ? 'rgba(128, 128, 128, 0.8)' : 'rgba(0, 0, 0, 1)'
  ...
  return (
    <Card className={className}>
      <CardHeader>
        <CardTitle>Draw Selection Area</CardTitle>
      ...
      <CardContent>
        ...
        <p className="text-sm text-gray-500 mt-2">
          Draw over the areas you want to edit. Gray areas will be processed with your prompt.
        </p>
      </CardContent>
    </Card>
  )
